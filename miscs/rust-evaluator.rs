            ...
            Evaluated::Function(
                Rc::new(
                    ...
                    | -> Evaluated {
                        ...
                        match condition {
                            Evaluated::Number(condition) => if condition == 1.0 {
            ...
            Evaluated::Function(
                Rc::new(
                    |
                        ...
                        defs: Rc<RefCell<Env>>
                    | -> Evaluated {
                        let condition: Evaluated = evaluate(
                            &args[0],
                            Rc::clone(&env),
                            Rc::clone(&defs)
                        );
                        match condition {
                            Evaluated::Number(condition) => if condition != 0.0 {
                                Evaluated::Number(0.0)
                            } else {
        ...
        env_ref.vars.insert(
            ...
            Evaluated::Function(
                Rc::new(
                    ...
                    | -> Evaluated {
                        match evaluate(&args[0], Rc::clone(&env), Rc::clone(&defs)) {
                            Evaluated::Number(a) => if a == 1.0 {
                                match evaluate(&args[1], Rc::clone(&env), Rc::clone(&defs)) {
                                    Evaluated::Number(b) => if b == 1.0 {
                                        Evaluated::Number(1.0)
                                    } else {
                                        Evaluated::Number(0.0)
                                    }
