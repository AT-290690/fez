...
(the generic:fold (lambda Unknown (lambda Unknown Unknown (do Unknown)) Unknown (do Unknown)))
(the generic:map (lambda Unknown (lambda Unknown (do Unknown)) (do Unknown)))
(the generic:enumerated-fold (lambda Unknown (lambda Unknown Number Unknown (do Unknown)) Unknown (do Unknown)))
(the generic:enumerated-map (lambda Unknown (lambda Unknown Number (do Unknown)) (do Unknown)))
(the generic:select (lambda Unknown (lambda Unknown (do Boolean)) (do Unknown)))
(the generic:exclude (lambda Unknown (lambda Unknown (do Boolean)) (do Unknown)))
(the generic:some? (lambda Unknown (lambda Unknown (do Boolean)) (do Boolean)))
(the generic:every? (lambda Unknown (lambda Unknown (do Boolean)) (do Boolean)))
(the generic:count (lambda Unknown[] Number (do Number)))
(the generic:count-of (lambda Unknown[] (lambda Unknown (do Boolean)) (do Number)))
