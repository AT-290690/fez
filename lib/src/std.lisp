...
(let new:set-512 (lambda (array:buckets 512)))
(let new:map-512 (lambda (array:buckets 512)))
(let new:set-1024 (lambda (array:buckets 1024)))
(let new:map-1024 (lambda (array:buckets 1024)))
(let new:set-2048 (lambda (array:buckets 2048)))
(let new:map-2048 (lambda (array:buckets 2048)))
