...
(let char:upper (lambda char (if (and (>= char char:a) (<= char char:z)) (- char char:space) char)))
(let char:lower (lambda char (if (and (>= char char:A) (<= char char:Z)) (+ char char:space) char)))
...
(let new:set128 (lambda (array:merge (new:set64) (new:set64))))
...
(let new:map128 (lambda (new:set128)))
(let new:set512 (lambda (array:buckets 512)))
(let new:map512 (lambda (array:buckets 512)))
(let new:set1024 (lambda (array:buckets 1024)))
(let new:map1024 (lambda (array:buckets 1024)))
(let new:set2048 (lambda (array:buckets 2048)))
(let new:map2048 (lambda (array:buckets 2048)))
(let new:set-n (lambda n (array:buckets n)))
(let new:map-n (lambda n (array:buckets n)))
